...
const formCadastroSubmit = async (e) => {
    ...
    try {
        ...
        const { clienteId, data, placa, operacao, status } = Object.fromEntries(formData); console.log(Object.fromEntries(formData))

        if(!clienteId || !data || !placa || !operacao || !status) throw Error(errValid001)
