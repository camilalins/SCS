...
class RecuperarSenhaController extends \controllers\core\BaseController {
    ...
    public function post() {
        ...
        try {
            ...
            if(!send_mail($email, "Recuperação de senha", "<p>Clique <a href='#'>aqui</a> para recuperar sua senha.</p>"))
